    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open_start('button');
            iattr('class', 'btn btn-default btn-lg btn-primary ddm-button form-builder-rule-settings-save');
            if (invalid) {
              iattr('disabled', '');
            }
            iattr('type', 'button');
        ...
        ie_open('button', null, null,
            'class', 'btn btn-cancel btn-default btn-lg btn-link form-builder-rule-settings-cancel',
            'type', 'button');
          ie_open('span', null, null,
              'class', 'lfr-btn-label');
...
function $btnAddNewTimelineItem(opt_data, opt_ignored, opt_ijData) {
  ...
  ie_open('div', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('a', null, null,
          'aria-role', 'button',
          'class', 'btn btn-primary btn-xs form-builder-timeline-add-item ' + (cssClass || ''),
          'href', 'javascript:;');
        plusIcon();
      ie_close('a');
    ie_close('div');
...
function $action(opt_data, opt_ignored, opt_ijData) {
  ...
  ie_open('li', null, null,
    ...
    ie_open('div', null, null,
        'class', 'panel panel-default');
      ie_open('div', null, null,
          'class', 'no-padding-bottom panel-body');
        ie_open('div', null, null,
            'class', 'row');
          ie_open('div', null, null,
...
exports.btnAddNewTimelineItem.params = ["cssClass","plusIcon"];
exports.btnAddNewTimelineItem.types = {"cssClass":"string","plusIcon":"html"};
exports.rulesHeader.params = ["extraContent","title"];
exports.rulesHeader.types = {"extraContent":"html","title":"string"};
