 ...
 *    strings: {basic: string, customized: string, field: string, fieldset: string},
...
function $render(opt_data, opt_ignored, opt_ijData) {
  ...
  var strings = goog.asserts.assertObject(opt_data.strings, "expected parameter 'strings' of type [basic: string, customized: string, field: string, fieldset: string].");
...
function $render_field_type_list_group(opt_data, opt_ignored, opt_ijData) {
  ...
  ie_open('div', null, null,
    ...
    for (var fieldTypeIndex134 = 0; fieldTypeIndex134 < fieldTypeListLen134; fieldTypeIndex134++) {
      ...
      ie_open('a', null, null,
          'class', 'list-group-item list-group-item-flex list-group-item-action lfr-ddm-form-builder-field-type-item',
...
function $render_field_set_list_group(opt_data, opt_ignored, opt_ijData) {
  ...
  ie_open('div', null, null,
    ...
    for (var fieldSetIndex147 = 0; fieldSetIndex147 < fieldSetListLen147; fieldSetIndex147++) {
      ...
      ie_open('a', null, null,
          'class', 'list-group-item list-group-item-flex list-group-item-action lfr-ddm-form-builder-field-set-item',
