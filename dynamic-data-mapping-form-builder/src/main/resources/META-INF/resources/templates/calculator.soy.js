  ...
  ie_open('div');
    ie_open('div', null, null,
      ...
      ie_open('button', null, null,
          'class', 'btn btn-default btn-lg btn-primary calculator-add-field-button ddm-button',
          'type', 'button');
    ...
    ie_open('div', null, null,
      ...
      ie_open('ul', null, null,
        ...
        ie_open('li', null, null,
            'class', 'border-top-left button-padding-icons calculator-button',
        ...
        ie_close('li');
        ie_open('li', null, null,
            'class', 'border-top-right calculator-button',
            'data-calculator-key', ')');
          itext(')');
        ie_close('li');
        ie_open('li', null, null,
        ...
        ie_close('li');
        ie_open('li', null, null,
            'class', 'border-bottom-left button-two-columns calculator-button',
            'data-calculator-key', '0');
          itext('0');
        ie_close('li');
        ie_open('li', null, null,
            'class', 'border-bottom-right calculator-button',
            'data-calculator-key', '.');
          itext('.');
        ie_close('li');
      ie_close('ul');
      ie_open('ul', null, null,
        ...
        ie_open('li', null, null,
            'class', 'border-top-left border-top-right button-padding-icons calculator-add-operator-button-area');
        ...
        ie_close('li');
        ie_open('li', null, null,
            'class', 'border-bottom-left border-bottom-right calculator-button',
            'data-calculator-key', '/');
          itext('/');
        ie_close('li');
      ie_close('ul');
