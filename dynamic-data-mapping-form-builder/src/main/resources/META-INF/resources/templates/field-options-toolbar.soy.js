...
DDMFieldSettingsToolbar.render = function(opt_data, opt_ignored) {
  ...
  return soydata.VERY_UNSAFE.ordainSanitizedHtml('<div class="dropdown dropdown-action show"><a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle icon-monospaced" data-toggle="dropdown" href="javascript:;" id="dropdownFieldToolbar" role="button">' + soy.$$escapeHtml(toolbarButtonIcon) + '</a>' + DDMFieldSettingsToolbar.field_settings_toolbar_list({options: toolbarTemplateContext.options}) + '</div>');
};
if (goog.DEBUG) {
...
DDMFieldSettingsToolbar.field_settings_toolbar_list = function(opt_data, opt_ignored) {
  ...
  var output = '<div aria-labelledby="dropdownFieldToolbar" class="dropdown-menu dropdown-menu-right">';
...
DDMFieldSettingsToolbar.field_settings_toolbar_item = function(opt_data, opt_ignored) {
  ...
  return soydata.VERY_UNSAFE.ordainSanitizedHtml('<a class="dropdown-item ' + soy.$$escapeHtmlAttribute(option.buttonClass || '') + '" data-handler="' + soy.$$escapeHtmlAttribute(option.handler) + '" href="javascript:;" title="' + soy.$$escapeHtmlAttribute(option.label) + '">' + soy.$$escapeHtml(option.label) + '</a>');
};
if (goog.DEBUG) {
