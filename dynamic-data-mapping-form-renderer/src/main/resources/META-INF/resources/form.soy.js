  ...
  ie_open('div', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('button', null, null,
          'class', 'btn btn-lg btn-primary hide lfr-ddm-form-pagination-prev',
          'type', 'button');
        ie_void('i', null, null,
      ...
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-lg btn-primary' + ((pages.length == 1) ? ' hide' : '') + ' lfr-ddm-form-pagination-next pull-right',
          'type', 'button');
      ...
      if (showSubmitButton) {
        ie_open('button', null, null,
            'class', 'btn btn-lg btn-primary' + ((pages.length > 1) ? ' hide' : '') + ' lfr-ddm-form-submit pull-right',
            'disabled', '',
            'type', 'submit');
